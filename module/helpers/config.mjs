...
MNM3E.ExtrasFlawsAll = {
  ...MNM3E.ExtrasGeneral,
  ...MNM3E.ExtrasUnique,
  ...MNM3E.FlawsGeneral,
  ...MNM3E.FlawsUnique
}
preLocalize("ExtrasFlawsAll");
...
MNM3E.AdvantageEnum = {
  ...
  benefitaltidentity: "MNM3E.advBenefitAltIdentity",
  benefitambidexterity: "MNM3E.advBenefitAmbidexterity",
  benefitcipher: "MNM3E.advBenefitCipher",
  benefitdiplomaticimmunity: "MNM3E.advBenefitDiplomaticImmunity",
  benefitsecurityclearance: "MNM3E.advBenefitSecurityClearance",
  benefitstatus: "MNM3E.advBenefitStatus",
  benefitwealth: "MNM3E.advBenefitWealth",
...
MNM3E.ExtrasFlawsAllDesc = {
  ...
  activation: "MNM3E.flActivationDesc",
  checkrequired: "MNM3E.flCheckRequiredDesc",
  concentration: "MNM3E.flConcentrationDesc",
  diminishedrange: "MNM3E.flDiminishedRangeDesc",
  distracting: "MNM3E.flDistractingDesc",
  fades: "MNM3E.flFadesDesc",
  feedback: "MNM3E.flFeedbackDesc",
  grabbased: "MNM3E.flGrabBasedDesc",
  inaccurate: "MNM3E.flInaccurateDesc",
  increasedaction: "MNM3E.flIncreasedActionDesc",
  limited: "MNM3E.flLimitedDesc",
  noticeable: "MNM3E.flNoticeableDesc",
  permanent: "MNM3E.flPermanentDesc",
  quirk: "MNM3E.flQuirkDesc",
  reducedrange: "MNM3E.flReducedRangeDesc",
  removable: "MNM3E.flRemovableDesc",
  easilyremovable: "MNM3E.flEasilyRemovableDesc",
  resistible: "MNM3E.flResistibleDesc",
  sensedependent: "MNM3E.flSenseDependentDesc",
  sideeffect: "MNM3E.flSideEffectDesc",
  tiring: "MNM3E.flTiringDesc",
  uncontrolled: "MNM3E.flUncontrolledDesc",
  unreliable: "MNM3E.flUnreliableDesc",
}
